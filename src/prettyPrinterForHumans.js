...
export default class prettyPrinterForHumans {
     ...
     * @returns any
     * */
    static getObjectWithoutTrackingAttributes =
        HelperCircularReferences.getObjectWithoutTrackingAttributes;
    //
    // Is
    //
    /**
        ...
        while (arrayStackToProcess.length > 0) {
            ...
            switch (itemObjectFromStack.fieldIntDataType) {
                ...
                case helperEnumDataTypes.fieldCircularReference:
                    ...
                    //
                    if (
                        argHelperOptions.argBoolPrintWarningOnCircularReference
                    ) {
                        arrayOfStringsOutput.push(
    ...
    static pformatAsyncSingleThread = async (
        ...
        new Promise((resolve) =>
            resolve(this.pformatSync(arg, argHelperOptions))
        );
    ...
    static pformatAsyncMultiThreaded = async (arg, argHelperOptions = {}) =>
        new Promise((resolve, reject) => {
            ...
            worker.onerror = (err) =>
                reject(
                    `${prettyPrinterForHumans.stringPathWorker}: err = ${err}`
                );
            //
            // Run worker
            //
